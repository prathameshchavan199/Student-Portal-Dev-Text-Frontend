    ...
    <StudentShell onSignOut={onSignOut}>
      <div className="db-page">
        ...
        <div className="db-skills-row">
          ...
          {/* Performance bars + Job chip */}
          <div className="db-card" style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div className="db-card-top">
              <div>
                <p className="db-section-label">SKILLS PERFORMANCE</p>
                <h3 className="db-card-title">Individual Competency</h3>
              </div>
              <span className="db-avg-badge">{masteryScore}% AVG.</span>
            </div>
            {[
              { label: 'Technical Skills',     p: technicalScore  },
              { label: 'Analytical Skills',    p: analyticalScore },
              { label: 'Communication Skills', p: commScore       },
            ].map(({ label, p }) => (
              <div key={label} className="db-perf-row">
                <div className="db-perf-header">
                  <span className="db-perf-label">{label}</span>
                  <span className="db-perf-pct">{p}%</span>
                </div>
                <div className="db-perf-bar-bg">
                  <div className="db-perf-bar-fill" style={{ width: `${p}%` }} />
                </div>
              </div>
            ))}
        ...
        <div className="db-sessions">
          <Link to="/courses-progress" className="db-session-row db-session-blue">
            ...
            <span className="db-session-count">12</span>
          </Link>
          <Link to="/courses-progress" className="db-session-row db-session-dark">
            ...
            <span className="db-session-count">8</span>
          </Link>
          <Link to="/courses-progress" className="db-session-row db-session-orange">
            ...
            <span className="db-session-count db-session-count-orange">5</span>
          </Link>
        </div>
            </div>
      </div>
